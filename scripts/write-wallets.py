...
function WalletCard({ wallet, showBalance }) {
  ...
  return (
    <div className="bg-surface-card rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
      ...
      <p className="font-poppins font-semibold text-2xl text-ink mb-5">{displayBalance}</p>
...
path = r'c:\Users\Ware\Documents\AfriXchange\frontend\src\pages\Wallets.jsx'
